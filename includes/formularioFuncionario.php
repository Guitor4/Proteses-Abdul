                    ...
                    <div class="col-11">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" name="telefone" onkeypress="mascara(this, '##-#####-####')" maxlength="13" placeholder="61-90000-0000" required="" value="<?= $objFuncionario->telefone ?>">
                            </div>
                            <div class="form-group">
                                <label>Perfil: </label>
                                <div class="form-check form-check-inline">
                        ...
                        <div class="d-flex justify-content-center p-2">
                            ...
                            <input type="submit" name="<?= BTN ?>" class="  btn btn-lg btn-success btInput" value="<?= (TITLE == "Cadastrar Funcionário" ? 'Cadastrar' : 'Editar') ?>" <?php //if ($btEnviar == TRUE) echo "disabled";
                                                                                                                                                                                            ?>>
