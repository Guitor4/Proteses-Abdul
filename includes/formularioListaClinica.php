  ...
  <section class="d-flex justify-content-center mt-2">
    <div class="col-4">
      <div class="bg-dark rounded p-2">
        <h5 style="color: white; text-align: center ">Clinics</h5>
        <form method="post" action="">
          ...
          <input type="submit" name="listaClinica" class="btn btn-secondary btInput p- d-flex " style="margin:auto" value="Search">
      ...
      <div class="row">
        <div class="col-6 p-2">
          <a href="listaClinica.php"> <input type="submit" value="Clear search" class="btn btn-danger w-100" /> </a>
        </div>
        <div class="col-6 p-2">
          <a href="cadastroClinica.php"> <input type="submit" value="Register Clinic" class="btn btn-success w-100" /> </a>
        </div>
      </div>
    </div>
      ...
      <div class="d-flex justify-content-center">
        <nav class="" aria-label="...">
          ...
          <li class="page-item">
            ...
            <li class="page-item">
              <a class="page-link" href="listaClinica.php?pagina=<?= ($pagina_atual > 1 ? $pagina_atual - 1 : $pagina_atual) ?><?=isset($_GET['search']) ? '&search='.$_GET['search'] : ''?>" tabindex="-1">Previous</a>
            </li>
            <?php
          ...
          for ($i = $pagina1; $i <= $limite_paginacao; $i++) {
            ...
            ?>
            <li class="page-item">
              <a class="page-link" href="listaClinica.php?pagina=<?= ($pagina_atual < $num_pagina ? $pagina_atual + 1 : $pagina_atual) ?><?=isset($_GET['search']) ? '&search='.$_GET['search'] : ''?>">Next</a>
            </li>
            <li class="page-item">
