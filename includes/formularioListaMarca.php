    ...
    <section class="d-flex justify-content-center mt-2">
        <div class="col-4">
            ...
            <div class="bg-dark rounded p-2">
                <h5 style="color: white; text-align: center ">Tooth Brands</h5>
                <form method="post" action="">
                    ...
                    <input type="submit" name="listaMarcaDente" class="btn btn-secondary btInput p- d-flex " style="margin:auto" value="Search">
            ...
            <div class="row">
                <div class="col-6 p-2">
                    <a href="listaMarcaDente.php"> <input type="submit" value="Clear search" class="btn btn-danger w-100" /> </a>
                </div>
                <div class="col-6 p-2">
