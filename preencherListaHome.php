...
$query1 = 'select idConsulta,nomePaciente,dataConsulta,horaConsulta,statusConsulta,relatorio, from consulta inner join paciente on prontuario = fkProntuario where statusConsulta = "Agendada" ORDER BY horaConsulta,dataConsulta,nomePaciente desc';
